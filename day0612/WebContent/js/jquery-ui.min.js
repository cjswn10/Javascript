...
(function(t) {
	...
	t.cleanData = function(e) {
		...
		return s || (s = i, i = t.Widget), t.isArray(s) && (s = t.extend.apply(null, [ {} ].concat(s))), t.expr[":"][l.toLowerCase()] = function(e) {
			...
			delete n._childConstructors
				) : i._childConstructors.push(a), t.widget.bridge(e, a), a
	...
	t(document).on("mouseup", function() {
		...
		_mouseUp : function(e) {
			...
			), this.ignoreMissingWhich = !1, u = !1, e.preventDefault()
		},
	...
	var c = t.ui.intersect = function() {
		...
		return function(e, i, s, n) {
			...
			switch (s) {
			case "fit":
				return a >= l && c >= r && o >= u && d >= h;case "intersect":
				return a + e.helperProportions.width / 2 > l && c > r - e.helperProportions.width / 2 && o + e.helperProportions.height / 2 > u && d > h - e.helperProportions.height / 2;case "pointer":
				return t(n.pageY, u, i.proportions().height) && t(n.pageX, l, i.proportions().width);case "touch":
				return (o >= u && d >= o || h >= u && d >= h || u > o && h > d) && (a >= l && c >= a || r >= l && c >= r || l > a && r > c);default:
				return !1
			}
		}
	}();
			...
			e.options.refreshPositions && t.ui.ddmanager.prepareOffsets(e, i), t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function() {
				if (!this.options.disabled && !this.greedyChild && this.visible) {
					var s,
						n,
						a,
						o = c(e, this, this.options.tolerance, i),
	...
	t.extend(s.prototype, {
		...
		parseDate : function(e, i, s) {
			...
			for (n = 0; e.length > n; n++)
				if (b)
					"'" !== e.charAt(n) || y("'") ? k() : b = !1;else switch (e.charAt(n)) {
					case "d":
						v = x("d");
						break;case "D":
						w("D", c, d);
		...
		formatDate : function(t, e, i) {
			...
			if (e)
				for (s = 0; t.length > s; s++)
					if (d)
						"'" !== t.charAt(s) || h("'") ? c += t.charAt(s) : d = !1;else switch (t.charAt(s)) {
						case "d":
							c += l("d", e.getDate(), 2);
							break;case "D":
							c += u("D", e.getDay(), n, a);
		...
		_generateMonthYearHeader : function(t, e, i, s, n, a, o, r) {
			var h,
				...
				y = "";
			if (a || !g)
				y += "<span class='ui-datepicker-month'>" + o[e] + "</span>";else {
		...
		_createButtons : function() {
			...
			return this.uiDialogButtonPane.remove(), this.uiButtonSet.empty(), t.isEmptyObject(i) || t.isArray(i) && !i.length ? (this._removeClass(this.uiDialog, "ui-dialog-buttons"), void 0) : (t.each(i, function(i, s) {
					...
					delete s.text
					, t("<button></button>", s).button(a).appendTo(e.uiButtonSet).on("click", function() {
		...
		load : function(e, i) {
			...
			var s = this,
				...
				h = function(t, e) {
					"abort" === e && s.panels.stop(!1, !0), s._removeClass(n, "ui-tabs-loading"), o.removeAttr("aria-busy"), t === s.xhr &&
					delete s.xhr
				};
